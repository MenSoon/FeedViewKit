...
open class FeedView:UIView {
    ...
    var _scrollDirection:UICollectionView.ScrollDirection = .vertical
    ...
    private func initCollectionView() {
        if self.layoutType == .water {
            ...
            layout.itemRenderDirection = .leoCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst
            self._layout = layout
