...
extension FeedPageView {
    ...
    open override func leo_collectionView (_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout,
        ...
        return super.leo_collectionView(collectionView, layout: collectionViewLayout, minimumColumnSpacingForSectionAtIndex: section)
    }
    ...
    open override func leo_collectionView (_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout,
        ...
        return super.leo_collectionView(collectionView, layout: collectionViewLayout, minimumLineSpacingForSectionAtIndex: section)
    }
